...
public class AgentDTO {
	...
	public AgentDTO(String id, String name, String ip, String port, String parentName, String parentIp,
			String parentPort, String centerIp, ArrayList<String> childrenAgents, Set<Log> logs) {
		super();
		this.id = id;
		this.name = name;
		this.ip = ip;
